# Ubiquitous Language — Vipassana France

## La technique et l'organisation

| Terme | Définition | Alias à éviter |
|-------|-----------|----------------|
| **Vipassana** | Technique de méditation telle qu'enseignée par S.N. Goenka dans la tradition de Sayagyi U Ba Khin | Méditation, Bouddhisme |
| **Dhamma** | L'organisation mondiale qui gère les centres Vipassana et le site dhamma.org | Association, Organisation |
| **La Technique** | Les instructions précises de méditation transmises pendant un Cours | Le contenu, La méthode |

## Les lieux

| Terme | Définition | Alias à éviter |
|-------|-----------|----------------|
| **Centre** | Lieu physique où se déroulent les Cours (ex. Dhamma Mahī, Dhamma Sūriyārāma) | Site (ambigu avec site web), Établissement |
| **Site** | Le site web Vipassana France (fr.dhamma.org puis le nouveau WordPress) | Page (trop vague) |

Centres actifs en France :
- **Dhamma Mahī** — Centre principal, Bourgogne
- **Dhamma Sūriyārāma** — Centre Sud
- **Sud-Est Devesset** — Centre Sud-Est
- **Dhamma Réunion** — Centre Île de la Réunion
...
| Terme | Définition | Alias à éviter |
|-------|-----------|----------------|
| **Cours** | Retraite de méditation structurée dans un Centre (typiquement 10 jours) | Retraite, Stage, Session — choisir **Cours** partout |
| **Cours de 10 jours** | Cours d'initiation à la Vipassana, prérequis pour devenir Ancien étudiant | Stage initial, Retraite d'initiation |
| **Cours Enfants et Jeunes** | Cours adaptés aux mineurs, format différent du Cours de 10 jours | Stage jeunes |
| **Calendrier** | Planning des Cours à venir dans les Centres, hébergé sur dhamma.org | Agenda, Programme |
| **Inscription** | Acte de s'enregistrer pour un Cours via dhamma.org (jamais via le Site) | Réservation, Enregistrement |
...
> **Dev :** "Est-ce qu'on affiche le Calendrier directement sur le Site ?"
>
> **Expert domaine :** "Non — le Calendrier est géré par Dhamma sur dhamma.org. Le Site pointe vers dhamma.org pour l'Inscription. On ne gère pas les Cours côté Site."
>
> **Dev :** "La Section Anciens étudiants, c'est pour tous les Étudiants ?"
>
> **Expert domaine :** "Non, uniquement les Anciens étudiants — ceux qui ont terminé au moins un Cours de 10 jours. C'est protégé par un mot de passe partagé, pas par compte individuel."
>
> **Dev :** "Et les Serviteurs, ils ont un accès spécial en plus ?"
>
> **Expert domaine :** "Non, les Serviteurs sont des Anciens étudiants qui s'impliquent dans les Centres — mais côté Site, ils ont le même accès que les autres Anciens étudiants."
